...
export async function POST(req: NextRequest) {
  try {
    ...
    const [data] = await sql`
      INSERT INTO jasa_orders (service_type, server_name, needs, discord_contact, status, created_at)
      VALUES (${service_type}, ${server_name}, ${needs}, ${discord_contact}, 'pending', NOW())
      RETURNING *
    `
